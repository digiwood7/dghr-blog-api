...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://d-onworks.com",
        "https://www.d-onworks.com",
    ],
    allow_origin_regex=r"https://.*\.vercel\.app|https://hr\.digiwood\.co\.kr|https://erp\.d-onworks\.com|https://(?:www\.)?d-onworks\.com|http://localhost:\d+|http://127\.0\.0\.1:\d+",
